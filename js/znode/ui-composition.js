$(function(){
  ...
  function saveFile(){
    ...
    $.post("json/composition_save.php", {data:graph.toJSON(), name:name}, function(data){
  ...
  $("#open").click(function(){
    ...
    openWin.fadeIn();
    fileList.load("json/oraignalPHP/oepn-composition.php?"+Math.random()*1000000);
  });
  ...
  $(".file").live('click', function() {
    var name = $(this).text();
    $.getJSON("files/composition/" + name + ".json", {n:Math.random()}, function(data){
       graph.fromJSON(data);
    ...
    $(this).css({"background-color": "white"});
      ...
      $.getJSON("files/composition/" + 'Composition_View' + ".json", {n:Math.random()}, function(data){
       graph.fromJSON(data);
	   filename.val(name);
	   });
