$(function(){
  ...
  function saveFile(){
    ...
    $.post("json/variable_save.php", {data:graph.toJSON(), name:name}, function(data){
  ...
  $("#open").click(function(){
    ...
    openWin.fadeIn();
    fileList.load("json/oraignalPHP/open-variable.php?"+Math.random()*1000000);
  });
  ...
  $(".file").live('click', function() {
    var name = $(this).text();
    $.getJSON("files/variable/" + name + ".json", {n:Math.random()}, function(data){
       graph.fromJSON(data);
    ...
    $(this).css({"background-color": "white"});
      ...
      $.getJSON("files/variable/" + 'Variable_View' + ".json", {n:Math.random()}, function(data){
       graph.fromJSON(data);
	   filename.val(name);
	   });
